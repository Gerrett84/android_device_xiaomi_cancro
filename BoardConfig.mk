...
# Flags
COMMON_GLOBAL_CFLAGS += -D__ARM_USE_PLD -D__ARM_CACHE_LINE_SIZE=64 -DNO_SCURE_DISCARD -DUSE_RIL_VERSION_10
...
# Recovery
TARGET_RECOVERY_FSTAB            := $(VIRGO_PATH)/rootdir/root/recovery_fstab.qcom
